	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
                    <div class="col-md-4"></div>  
                            <h3 style="text-align: center;"><b>Encaissements Journaliers</b></h3>
                            <h4 style="text-align: center;"><u>  Total pour la jourrnée du ${enc.jour}-${enc.mois}-${enc.annee}:</u> <b> ${enc.total} DTN </b></h4>
                    </div>
		<div class="panel-body">
                    <form:form class="form-horizontal" method="POST" action="journaliersForm.htm" modelAttribute="enc">    
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                    <br><br><br><br><center><H3>Aucun encaissement enregistré pendant le ${enc.jour}-${enc.mois}-${enc.annee}.</H3></center><br><br><br><br><br><br><br><br><br><br><br><br>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
