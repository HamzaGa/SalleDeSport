	...
	<div class="col-md-12">
		...
		<div class="panel-heading">
                    <div class="col-md-4"></div>  
                            <h3 style="text-align: center;"><b>Encaissements Annuels</b></h3>
                            <h4 style="text-align: center;"><u> Total pour l'année  ${enc.annee}:</u> <b>${enc.total} DNT</b></h4>
                
                </div>
		<div class="panel-body">
                    <!--<input type="button" class="btn btn-default"  value="Année" onclick="ajoutD();">-->
                    <form:form class="form-horizontal" method="POST" action="annuelsForm.htm" modelAttribute="enc">    
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                    <br><br><br><br><center><H3>Aucun encaissement enregistré pendant l'année ${enc.annee}.</H3></center><br><br><br><br><br><br><br><br><br><br><br><br>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
