			  				...
			  				<div class="panel-body">
								...
								<div class="row">
								    ...
								    <div class="col-sm-7">
								      <form:input path="a.telP" type="text" cssClass="form-control" id="inputEmail3" />
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-2"><H3><b>Disciplines:</b>
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-7">
								      <form:select id="c11" onChange="verrou();" cssClass="form-control" path="dispchoix.id">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-7">
								    <form:select id="c12" onChange="verrou();" cssClass="form-control" path="dispchoix.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-7">
								      <form:select id="c13" onChange="verrou();" cssClass="form-control" path="dispchoix.id">
                                                                        <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-7">
								      <form:select id="c14" onChange="verrou();" cssClass="form-control" path="dispchoix.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Enfants </label>
								    <div class="col-sm-7">
								      <form:select id="c21" onChange="verrou();" cssClass="form-control" path="dispchoix2.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Hommes </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c22" cssClass="form-control" path="dispchoix2.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Femmes </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c23" cssClass="form-control" path="dispchoix2.id">
                                                                        <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Mixte </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c24" cssClass="form-control" path="dispchoix2.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Enfants </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c31" cssClass="form-control" path="dispchoix3.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Hommes </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c32" cssClass="form-control" path="dispchoix3.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Femmes </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c33" cssClass="form-control" path="dispchoix3.id">
                                                                        <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-5 control-label">Mixte </label>
								    <div class="col-sm-7">
								      <form:select onChange="verrou();" id="c34" cssClass="form-control" path="dispchoix3.id">
                                                                          <form:option value="0">Choisir une discipline</form:option>
                                                                          <c:forEach var="listValue" items="${f.d}">
